...
/**
 *@description 计算器控制计算(加减乘除)
 *@author dxh
 *@date 2018年7月17日11:12:54 
 */
public class cacuinterface {
	/**
	 *模糊查询百度接口(数学公式) 
	 */
	public static String analysisIssueToCalcute(String expression){
		String resultstr = "";
		try {
			//分析句子意思 1，数学公式
			int data = evaluateExpression(expression);
